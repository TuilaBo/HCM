...
export default function BuildingSocialismVietnamPage() {
  ...
  const title =
    language === "vi"
      ? buildingSocialismVietnamContent.titleVi
      : buildingSocialismVietnamContent.titleEn

  const description =
    language === "vi"
      ? buildingSocialismVietnamContent.descriptionVi
      : buildingSocialismVietnamContent.descriptionEn

  const content = buildingSocialismVietnamContent.content
